...
[`tests/test_action_conventions.py`](https://github.com/ecmwf/ci-infrastructure/blob/main/tests/test_action_conventions.py) enforces both halves, so it stays true as
actions are added.
...
checkout instead of a baked interpreter; see [](../howto/images.md).
