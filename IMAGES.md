...
limit"*. The **Registry prune** workflow runs
[`scripts/registry_prune.py`](scripts/registry_prune.py) nightly, before the
nightly image build. It deletes all but the two most recently pushed versions of
